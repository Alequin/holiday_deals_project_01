...
class TestDeal < MiniTest::Test
  ...
  def test_set_dates__correct_value()
    ...
    assert_equal("31/03/2017", @deal.get_formatted_start_date())

    end_date_input = "2018-01-01"
    @deal.set_end_date(end_date_input)
    assert_equal("01/01/2018", @deal.get_formatted_end_date())
  end

  def test_set_dates__incorrect_value()
    end_date_input = "2016-01-01"
    @deal.set_end_date(end_date_input)
    assert_equal(@deal.get_formatted_start_date(), @deal.get_formatted_end_date())
  end
